...
# ✅ Deploy NAT Gateway in the First Public Subnet
resource "aws_nat_gateway" "this" {
  ...
  depends_on = [aws_internet_gateway.this]  # Ensures IGW is created first
}
...
resource "aws_security_group" "rds_sg" {
  ...
  # Allow MySQL/PostgreSQL traffic only from private subnets
  ingress {
